...
## 编辑器使用提示📎
   ...
   * 最近偶然发现的一个问题：**ADBlock扩展会把“新建文章”按钮给隐藏掉!**  

      ![20220423232609-2022-04-23](https://cdn.jsdelivr.net/gh/cat-note/bottleassets@latest/img/QQ%E6%88%AA%E5%9B%BE20220423232609-2022-04-23.jpg)  

      大概是因为我给按钮取的id里面有"ad"😂...解决方法就是**在当前页面关闭ADBlock**   
